...
def handle_month(page):
    confirm_button = page.get_by_role("option", name="Fevereiro/2024").click()
    if confirm_button:
        try:
            confirm_button.click()
            return True
...
dados_json = '''
{
  "dados": [
    ...
    },
    {
      ...
      "email": "fiscal@escritorioipiranga.com.br",
    ...
    {
      "nome": "52.023.700 JOSI MARA DA CRUZ QUIDEROLI",
      "email": "suporte6.excelent@gmail.com",
      "nome_email": "TOP LAR PRODUTOS DE LIMPEZA",
      "isPDV": "2"
    },
    {
      "nome": "CRISTIELLEN FERNANDA DE ARAUJO",
      "email": "suporte6.excelent@gmail.com",
      "nome_email": "ARAUJO'S GOURMET",
      "isPDV": "0"
    },
    {
      "nome": "SERGIO DONIZETI GOMES DE ANDRADE 04408261874",
      "email": "escritafiscal@martinezcontabil.com.br",
      "nome_email": "QUASIMPE CALCADOS INFANTIL - ME",
      "isPDV": "0"
    },
    {
      "nome": "M & S BIRIGUI COMERCIO DE AGUA E GAS LTDA",
      "email": "ana.jcescritorio@gmail.com",
      "nome_email": "M & S BIRIGUI COMERCIO DE AGUA E GAS LTDA",
      "isPDV": "2"
    },
    {
      "nome": "DANILO GOBI 37514426850",
      "email": "escritafiscal@martinezcontabil.com.br",
      "nome_email": "QUASIMPE CALCADOS INFANTIL - ME",
      "isPDV": "0"
    },
    {
      "nome": "A. C. FERREIRA DOS SANTOS COMERCIO DE BEBIDAS",
      "email": "escritafiscal@martinezcontabil.com.br",
      "nome_email": "QUASIMPE CALCADOS INFANTIL - ME",
      "isPDV": "1"
    }
